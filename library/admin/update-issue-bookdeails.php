...
<head>
    ...
    <title>Gestion de Bibliotheque | Détails du livre émis</title>
...
<!-- FIN DE LA SECTION DU MENU-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Détails du livre émis</h4>
...
<div class="form-group">
<label>Temps d'enprumte:</label>
<?php echo htmlentities($result->ISBNNumber);?>
</div>

<div class="form-group">
<label>Date d'émission du livre :</label>
...
?>
 ...
 <?php if($result->RetrunStatus==0){?>
    ...
    <a href="manage-issued-books.php?rid=">Retour</button>
