...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Gestion de Bibliotheque | Tableau de bord d'administration</title>
...
<!-- FIN DE LA SECTION DU MENU-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Tableau de bord d'administration</h4>
