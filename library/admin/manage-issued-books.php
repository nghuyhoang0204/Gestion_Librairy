...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            {
                                                echo htmlentities("Pas encore de retour");
                                            } else {
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Détail</button> 
